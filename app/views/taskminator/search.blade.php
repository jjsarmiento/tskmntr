                ...
                <div class="widget-container fluid-height">
                    <div class="widget-content">
                        <div class="panel-group" id="accordion">
                            ...
                            {{ Form::open(array('url' => '/tskmntr/doTaskSearch', 'id' => 'searchForm')) }}
                                <div class="panel">
                    ...
                    @if($tasks->count() != 0)
                        @foreach($tasks as $task)
                            <div class="widget-container fluid-height padded">
                                ...
                                @else
                                    <br/><a href="/bid{{$task->workTime}}/{{ $task->id }}" class="btn btn-default" style="border:1px solid #2980b9;">Bid for task</a>
                                @endif
                            </div><br/>
                        @endforeach
