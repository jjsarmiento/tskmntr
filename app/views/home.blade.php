                        ...
                        {{ Form::open(array('url' => '/regWorker', 'id' => 'minimalRegForm_Worker')) }}
                            <div class="col-lg-10 signUpDiv" style="">
                                ...
                                <div class="col-lg-12 lato-text">
                                    <p style="padding:0;margin:0;font-size:10pt; color:#0f0f0f">By clicking Sign Up, you agree to our <a href="#" data-target="#TERMSMODAL" data-toggle="modal">Terms</a> and that you have read our <a href="#">Privacy Policy</a>.</p>
                                </div>
