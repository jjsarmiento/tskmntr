                ...
                <div class="widget-container">
                    <div class="widget-content">
                        ...
                        <div class="panel-body">
                            ...
                            <i class="glyphicon glyphicon-chevron-right"></i> &nbsp; <a href="#" class="sidemenu">Individual</a><br>
                            <i class="glyphicon glyphicon-chevron-right"></i> &nbsp; <a href="#" class="sidemenu">Featured</a><br>
                            <i class="glyphicon glyphicon-chevron-right"></i> &nbsp; <a href="#" class="sidemenu">Mass Hiring</a><br>
                            <i class="glyphicon glyphicon-chevron-right"></i> &nbsp; <a href="#" class="sidemenu">Referal</a><br>
                        </div>
                        {{--<div class="panel-heading">--}}
                            {{--<div class="panel-title">--}}
                                {{--<a class="accordion-toggle">--}}
