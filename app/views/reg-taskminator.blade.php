...
<div class="taskminator-form">
    <h3 style="text-align:center; color: #f9f9f9">Worker Information</h3>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    {{ Form::open(array('url' => '/doRegisterTaskminator', 'id' => 'registrationForm-task')) }}
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                @if( $firstName != "")
                                    {{ Form::text('firstName', $firstName, array('data-name' => 'First Name', 'class' => 'inputItem form-control', 'placeholder' => 'First name', 'required' => 'true')) }}
                                @else
                                ...
                                <div class="col-md-5">
                                @if ( $lastName != "")
                                    {{ Form::text('lastName', $lastName, array('data-name' => 'Last Name', 'class' => 'inputItem form-control', 'placeholder' => 'Last name', 'required' => 'true')) }}
                                @else
                        ...
                        <!-- <div class="g-recaptcha" data-sitekey="6LcLdR8TAAAAAIdBnbqe8ro-tO27mx9l1uNXfoHI"></div> -->
                        <br>
